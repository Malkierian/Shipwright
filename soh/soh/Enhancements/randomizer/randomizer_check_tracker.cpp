...
int checkLoops = 0;
int checkCounter = 0;
int remoteCheckLoops = 0;
int remoteCheckCounter = 0;
u16 savedFrames = 0;
...
RandomizerCheckArea AreaFromEntranceGroup[] = {
    ...
    RCAREA_WASTELAND,        RCAREA_MARKET,        RCAREA_HYRULE_CASTLE,
};
...
std::map<RandomizerCheck, QuestItem> QuestItemFromCheck = { { RC_QUEEN_GOHMA, QUEST_KOKIRI_EMERALD },
