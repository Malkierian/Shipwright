...
std::vector<ItemTrackerItem> equipmentItems = {
    ITEM_TRACKER_ITEM(ITEM_SWORD_KOKIRI, EQUIP_FLAG_SWORD_KOKIRI, DrawEquip),  ITEM_TRACKER_ITEM(ITEM_SWORD_MASTER,  EQUIP_FLAG_SWORD_MASTER, DrawEquip),  ITEM_TRACKER_ITEM(ITEM_SWORD_BGS,     EQUIP_FLAG_SWORD_BGS, DrawEquip),
    ITEM_TRACKER_ITEM(ITEM_TUNIC_KOKIRI, EQUIP_FLAG_TUNIC_KOKIRI, DrawEquip),  ITEM_TRACKER_ITEM(ITEM_TUNIC_GORON,   EQUIP_FLAG_TUNIC_GORON, DrawEquip),   ITEM_TRACKER_ITEM(ITEM_TUNIC_ZORA,    EQUIP_FLAG_TUNIC_ZORA, DrawEquip),
    ITEM_TRACKER_ITEM(ITEM_SHIELD_DEKU,  EQUIP_FLAG_SHIELD_DEKU, DrawEquip),   ITEM_TRACKER_ITEM(ITEM_SHIELD_HYLIAN, EQUIP_FLAG_SHIELD_HYLIAN, DrawEquip), ITEM_TRACKER_ITEM(ITEM_SHIELD_MIRROR, EQUIP_FLAG_SHIELD_MIRROR, DrawEquip),
    ITEM_TRACKER_ITEM(ITEM_BOOTS_KOKIRI, EQUIP_FLAG_BOOTS_KOKIRI, DrawEquip),  ITEM_TRACKER_ITEM(ITEM_BOOTS_IRON,    EQUIP_FLAG_BOOTS_IRON, DrawEquip),    ITEM_TRACKER_ITEM(ITEM_BOOTS_HOVER,   EQUIP_FLAG_BOOTS_HOVER, DrawEquip),
};
...
std::vector<ItemTrackerItem> miscItems = {
    ...
    ITEM_TRACKER_ITEM(QUEST_GERUDO_CARD, 0, DrawQuest),   ITEM_TRACKER_ITEM(QUEST_SKULL_TOKEN, 0, DrawQuest), ITEM_TRACKER_ITEM(QUEST_STONE_OF_AGONY, 0, DrawQuest),
};

std::vector<ItemTrackerItem> dungeonRewardStones = {
    ITEM_TRACKER_ITEM(QUEST_KOKIRI_EMERALD, 0, DrawQuest), ITEM_TRACKER_ITEM(QUEST_GORON_RUBY, 0, DrawQuest), ITEM_TRACKER_ITEM(QUEST_ZORA_SAPPHIRE, 0, DrawQuest),
};

std::vector<ItemTrackerItem> dungeonRewardMedallions = {
    ITEM_TRACKER_ITEM(QUEST_MEDALLION_FOREST, 0, DrawQuest), ITEM_TRACKER_ITEM(QUEST_MEDALLION_FIRE, 0, DrawQuest),   ITEM_TRACKER_ITEM(QUEST_MEDALLION_WATER, 0, DrawQuest),
    ITEM_TRACKER_ITEM(QUEST_MEDALLION_SPIRIT, 0, DrawQuest), ITEM_TRACKER_ITEM(QUEST_MEDALLION_SHADOW, 0, DrawQuest), ITEM_TRACKER_ITEM(QUEST_MEDALLION_LIGHT, 0, DrawQuest),
};
