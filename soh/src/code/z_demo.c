...
EntranceCutscene sEntranceCutsceneTable[] = {
    ...
    { ENTR_DEATH_MOUNTAIN_CRATER_BRIDGE_EXIT, 2, 0xB9, gDeathMountainCraterIntroCs },
...
void func_80064824(PlayState* play, CutsceneContext* csCtx, CsCmdBase* cmd) {
    ...
    switch (cmd->base) {
        ...
        case 3:
            if (sp3F != 0) {
                Flags_SetEnv(play, 0);
                if (gSaveContext.entranceIndex == ENTR_TEMPLE_OF_TIME_ENTRANCE || (IS_RANDO && gSaveContext.entranceIndex == ENTR_TEMPLE_OF_TIME_7)) {
                    Flags_SetEnv(play, 2);
                }
            }
            break;
                    ...
                    if ((temp == 0.0f) && (gSaveContext.entranceIndex == ENTR_CHAMBER_OF_THE_SAGES_0)) {
                        Audio_PlaySoundGeneral(NA_SE_SY_WHITE_OUT_S, &D_801333D4, 4, &D_801333E0, &D_801333E0,
                               ...
                               ((gSaveContext.entranceIndex == ENTR_TEMPLE_OF_TIME_ENTRANCE) || (gSaveContext.entranceIndex == ENTR_CASTLE_GROUNDS_SOUTH_EXIT) ||
                                (gSaveContext.entranceIndex == ENTR_GREAT_FAIRYS_FOUNTAIN_ZF_FARORE))) {
